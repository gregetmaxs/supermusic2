console.log(`Welcome to SERVICE HANDLER /--/ By ExSkull `.yellow);
...
module.exports = (client) => {
  ...
  function receiveQueueData(newQueue, newTrack) {
    ...
    .setDescription(`**[Click Here for Re-Invite me with __Slash Commands__ Permissions!!](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot%20applications.commands), cause all of my Commands are available as Slash Commands too!** \n\n See the [Queue on the **DASHBOARD** Live!](${websiteSettings.website.domain}/queue/${newQueue.id})`)
